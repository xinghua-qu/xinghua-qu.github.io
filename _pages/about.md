...
redirect_from: 
  ...
  - /about.html
---
I am a **Principal Research Scientist** specializing in Agentic Interaction Models. Previously, I was a Research Scientist and Tech Lead at **ByteDance Seed**, where I focused on multimodal LLMs and Reinforcement Learning. I received my PhD from Nanyang Technological University (NTU, Singapore) in 2022, where I worked on Deep Reinforcement Learning.
...
**Recent news**
<div markdown="1" style="max-height: 300px; overflow-y: auto; border: 1px solid #e1e4e8; border-radius: 6px; padding: 10px 16px; margin-bottom: 1em; background: #fafbfc;">
